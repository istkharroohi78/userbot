...
from ISTKHAR import CMD_HELP, StartTime, app
from ISTKHAR.helper.data import Data
from ISTKHAR.helper.inline import inline_wrapper, paginate_help
...
<b> • 𝗜𝗦𝗧𝗞𝗛𝗔𝗥 :</b> {message.from_user.mention}
